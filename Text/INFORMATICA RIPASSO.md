...
Abbiamo visto come il percorso dagli archivi tradizionali ai moderni sistemi di basi di dati rappresenti un salto di qualità epocale. Non si tratta più solo di *salvare* dati, ma di *governare l'informazione*. L'architettura a tre livelli ci permette di gestire la complessità, il modello relazionale ci dà rigore e flessibilità, le proprietà ACID ci garantiscono l'affidabilità, e le architetture distribuite ci permettono di sognare in grande, su scala planetaria. Padroneggiare questi concetti significa possedere la chiave per interpretare e costruire il sistema informativo del futuro.
